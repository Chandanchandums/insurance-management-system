...
<head>
    ...
    <link rel="stylesheet" href="./hpd.css">
...
<body>
    ...
    <div class="plan" id="plan">
        <?php
            ...
            $sql_query=mysqli_query($con,"SELECT * FROM health_ins");
            while($res=mysqli_fetch_array($sql_query))
            {
                ?>
                    ...
                    <form action="./hpd_delete.php" method="POST">
                    <input type="hidden" name="rn" value="<?php echo $res['hplanid'];?>">
                    <input type="submit" value="DELETE" class="button">
                    </form>
                    <form action="./hpd_updatehtml.php" method="POST">
                    <input type="hidden" name="pname" id="n" value="<?php echo $res['plan_name'];?>">
                    <input type="hidden" name="pamnt" id="d" value="<?php echo $res['pamnt'];?>"><br>
                    <input type="hidden" name="iamnt"  id="e" value="<?php echo $res['iamnt'];?>">
                    <input type="hidden" name="tp"  id="p" value="<?php echo $res['tp'];?>"><br>
                    <input type="hidden" name="hplanid"  id="hid" value="<?php echo $res['hplanid'];?>"><br>
                    <input type="SUBMIT" value="UPDATE" class="button" id="u">
                    </form>   
                </div>
         <?php
            }
        ?>
        <div class="insert">
            <a href="./hpd_insert.html"><img src="./icons/plus-square-dotted.svg" alt="plus" height="40px" width="10%"></a>   
        </div>
    </div>
